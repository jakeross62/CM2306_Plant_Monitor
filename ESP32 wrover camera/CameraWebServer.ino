...
const char *ssid_Router     = "BT-SNCTHF";  //input your wifi name
const char *password_Router = "9c7Q3QY7T7Pv3u";  //input your wifi passwords
camera_config_t config;

//Sending to the endpoint
const char *Website = ""; //Website address will go here, think it is ip address
const char *endpoint = "";
